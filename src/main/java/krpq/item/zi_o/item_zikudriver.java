...
import krpq.model.model_belt_plus;
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof ItemArmor)
			{
				...
				Item[] armor_watch= new Item[] {RiderItems.blanknoitem        ,RiderItems.ziku_driver_build       ,RiderItems.ziku_driver_exaid       ,RiderItems.ziku_driver_ghost       ,RiderItems.ziku_driver_drive       ,RiderItems.ziku_driver_gaim       ,RiderItems.ziku_driver_wizard       ,RiderItems.ziku_driver_fourze       ,RiderItems.ziku_driver_ooo       ,RiderItems.ziku_driver_w       ,RiderItems.ziku_driver_kiva       ,RiderItems.ziku_driver_deno        ,RiderItems.ziku_driver_kabuto       ,RiderItems.ziku_driver_hibiki       ,RiderItems.ziku_driver_blade       ,RiderItems.ziku_driver_faiz       ,RiderItems.ziku_driver_ryuki       ,RiderItems.ziku_driver_agito       ,RiderItems.ziku_driver_kuuga       ,RiderItems.ziku_driver_genm       ,RiderItems.blanknoitem       ,RiderItems.ziku_driver_exaid       ,RiderItems.blanknoitem,RiderItems.blanknoitem,RiderItems.blanknoitem,RiderItems.ziku_driver_cross_z       ,RiderItems.ziku_driver_grease       ,RiderItems.ziku_driver_rogue       ,RiderItems.ziku_driver_evol       ,RiderItems.ziku_driver_mad_rogue       ,RiderItems.ziku_driver_garren       ,RiderItems.ziku_driver_brave       ,RiderItems.ziku_driver_blood       ,RiderItems.ziku_driver_killbus       ,RiderItems.ziku_driver_build_sparkling,RiderItems.ziku_driver_build_hazard,RiderItems.ziku_driver_build_rabbit_rabbit,RiderItems.ziku_driver_build_tank_tank,RiderItems.ziku_driver_build_genius,RiderItems.ziku_driver_build_gorilla_mond,RiderItems.ziku_driver_build_hawk_gatling,RiderItems.ziku_driver_build_ninnin_comic,RiderItems.ziku_driver_build_rocket_panda,RiderItems.ziku_driver_build_fire_hedgehog,RiderItems.ziku_driver_build_lion_cleaner,RiderItems.ziku_driver_build_key_dragon,RiderItems.ziku_driver_build_kaizoku_ressha,RiderItems.ziku_driver_build_octopus_light,RiderItems.ziku_driver_build_phoenix_robo,RiderItems.ziku_driver_build_smapho_wolf,RiderItems.ziku_driver_build_uni_raser,RiderItems.ziku_driver_build_rose_copter,RiderItems.ziku_driver_build_turtle_watch,RiderItems.ziku_driver_build_beetle_camera,RiderItems.ziku_driver_build_kuma_televi,RiderItems.ziku_driver_build_dog_mic,RiderItems.ziku_driver_build_merry_christmas,RiderItems.ziku_driver_build_spider_cooler,RiderItems.ziku_driver_build_tora_ufo,RiderItems.ziku_driver_build_kujira_jet,RiderItems.ziku_driver_build_shika_mid,RiderItems.ziku_driver_build_kirin_cyclone,RiderItems.ziku_driver_build_penguin_skater};
				Item[] decade_watch= new Item[] {RiderItems.ziku_driver_decade,RiderItems.ziku_driver_decade_build,RiderItems.ziku_driver_decade_exaid,RiderItems.ziku_driver_decade_ghost,RiderItems.ziku_driver_decade_drive,RiderItems.ziku_driver_decade_gaim,RiderItems.ziku_driver_decade_wizard,RiderItems.ziku_driver_decade_fourze,RiderItems.ziku_driver_decade_ooo,RiderItems.ziku_driver_decade_w,RiderItems.ziku_driver_decade_kiva,RiderItems.ziku_driver_decade_den_o,RiderItems.ziku_driver_decade_kabuto,RiderItems.ziku_driver_decade_hibiki,RiderItems.ziku_driver_decade_blade,RiderItems.ziku_driver_decade_faiz,RiderItems.ziku_driver_decade_ryuki,RiderItems.ziku_driver_decade_agito,RiderItems.ziku_driver_decade_kuuga,RiderItems.ziku_driver_decade_genm,RiderItems.ziku_driver_decade,RiderItems.ziku_driver_decade_exaid,RiderItems.blanknoitem,RiderItems.blanknoitem,RiderItems.blanknoitem,RiderItems.ziku_driver_decade_cross_z,RiderItems.ziku_driver_decade_grease,RiderItems.ziku_driver_decade_rogue,RiderItems.ziku_driver_decade_evol,RiderItems.ziku_driver_decade_mad_rogue,RiderItems.ziku_driver_decade_garren,RiderItems.ziku_driver_decade_brave,RiderItems.ziku_driver_decade_blood,RiderItems.ziku_driver_decade_killbus,RiderItems.blanknoitem                ,RiderItems.blanknoitem             ,RiderItems.blanknoitem                    ,RiderItems.blanknoitem                ,RiderItems.blanknoitem             ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                    ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                 ,RiderItems.blanknoitem                     ,RiderItems.blanknoitem                    ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                  ,RiderItems.blanknoitem                ,RiderItems.blanknoitem                  ,RiderItems.blanknoitem                   ,RiderItems.blanknoitem                    ,RiderItems.blanknoitem                  ,RiderItems.blanknoitem              ,RiderItems.blanknoitem                      ,RiderItems.blanknoitem                    ,RiderItems.blanknoitem               ,RiderItems.blanknoitem                 ,RiderItems.blanknoitem                ,RiderItems.blanknoitem                    ,RiderItems.blanknoitem                     };
				...
				}else if (item_zikudriver.get_lockbase(stack)=="build_hawk_gatling" && item_zikudriver.get_core(stack, "1")!=1){
                    armorModel.wings=new ItemStack(RiderItems.hawk_gatling_wings);
				}else if (item_zikudriver.get_lockbase(stack)=="build_phoenix_robo" && item_zikudriver.get_core(stack, "1")!=1){
