	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
		if(!stack.isEmpty()) {
			if(stack.getItem() instanceof ItemArmor) {
				...
				Item[] build_form= new Item[] {RiderItems.blanknoitem,RiderItems.build_driver_sp,RiderItems.build_driver_hazard,RiderItems.build_driver_hazard_rabbit,RiderItems.build_driver_hazard_tank,RiderItems.build_driver_genius,RiderItems.build_driver_cross_z_build,RiderItems.build_driver_full_rabbittank,RiderItems.build_driver_hazard_gorilla};
				...
				Item[] evol_form= new Item[] {RiderItems.evol_driver_cobra,RiderItems.evol_driver_dragon,RiderItems.evol_driver_rabbit,RiderItems.evol_driver_blackhole,RiderItems.evol_driver_blackhole,RiderItems.evol_driver_lock};
				...
				if(stack.getItem() == RiderItems.build_driver)
				{
					...
					if (item_OOOdriver.get_core(stack,"2")!=1&item_OOOdriver.get_core(stack,"2")!=3&item_OOOdriver.get_core(stack,"2")!=4&item_OOOdriver.get_core(stack,"2")!=5&item_OOOdriver.get_core(stack,"2")!=6&item_OOOdriver.get_core(stack,"2")!=7&item_OOOdriver.get_core(stack,"2")!=8){
								...
								if (player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() == RiderItems.buildhead){		
									...
									if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == RiderItems.build_driver){
										...
										if (get_core(ItemStack,"2")==1){
											...
											player.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 5, 0,true,false));
											player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 5, 1,true,false));
										}else if (get_core(ItemStack,"2")==7){
											player.addPotionEffect(new PotionEffect(MobEffects.STRENGTH, 5, 4,true,false));			
											player.addPotionEffect(new PotionEffect(MobEffects.SPEED, 5, 3,true,false));
											player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 5, 3,true,false));
											player.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, 5, 3,true,false));
