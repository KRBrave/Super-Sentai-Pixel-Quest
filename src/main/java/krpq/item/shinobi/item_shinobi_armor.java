...
import krpq.model.BipedLockseed;
...
public class item_shinobi_armor extends ItemArmor implements IHasModel
{
	...
	public item_shinobi_armor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
		...
		if (entity instanceof EntityLivingBase){
			...
			if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null){
				...
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_shinobi_changer){
					...
					return Refercence.MODID+":textures/armor/"+rider+CoreName[item_shinobi_changer.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))]+"_base_1.png";
				}
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_shinobi_armor)
			{
