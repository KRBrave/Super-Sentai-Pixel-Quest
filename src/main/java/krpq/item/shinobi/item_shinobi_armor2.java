...
public class item_shinobi_armor2 extends ItemArmor implements IHasModel
{
	public static final String[] CoreName= new String[] {"","_sword","_stealth","_scythe","_steel","_strength","_scar","_saikou"};

	private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
	public String armorNamePrefix;
	public ArmorMaterial material;

	public item_shinobi_armor2 (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if (entity instanceof EntityLivingBase){
			...
			if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null){
				...
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_shinobi_changer){
...

{
							...
							{
								return Refercence.MODID+":textures/armor/"+rider+CoreName[item_shinobi_changer.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))]+"_2.png";	
							}
							if (slot == EntityEquipmentSlot.HEAD||slot == EntityEquipmentSlot.CHEST )
							{
								return Refercence.MODID+":textures/armor/"+rider+CoreName[item_shinobi_changer.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))]+"_1.png";	
						}
					}
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		...
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_shinobi_armor2)
