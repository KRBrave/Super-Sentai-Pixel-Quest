...
{
	public static final String[] CoreName1= new String[] {"taka","kuwagata","lion","sai","shachi","ptera","cobra","super_taka","love_1","same","shika","seiuchi","mukade","ebi","habataki","taka_ankh","shocker_head","taka_eternity","ancient_taka","ancient_taka_greeed_absorption","mukade_goda","super_lion","super_sai","super_sachi","super_cobra","super_same","super_shika","super_seiuchi","super_mukade","super_ebi_new","super_love_core","super_ptera","super_kuwagata"};
	public static final String[] CoreName2= new String[] {"tora","kamakiri","gorilla","kujaku","unagi","tricera","kame","imagin","panda","super_tora","kangaroo","love_2","kujira","gazelle","shirokuma","hachi","kani","yadokari","taiga","gel_shocker","kujaku_eternity","ancient_tora","ancient_tora_greeed_absorption","hachi_goda","super_tricera","super_kujaku","super_kamakiri","super_gorilla","super_unagi","super_kame","super_imagin","super_kujira","super_gazelle","super_shirokuma","super_hachi","super_kani_new","super_panda","super_kangaroo","super_yadokari","super_love_core2"};
	public static final String[] CoreName3= new String[] {"batta","cheetah","zou","condor","tako","tyranno","wani","shocker","super_batta","kangaroo2","love_3","ookamiuo","ushi","penguin","ari","sasori","ichigo","destron","condor_eternity","ancient_batta","ancient_batta_greeed_absorption","ari_goda","super_tyranno","super_condor","super_cheetah","super_zou","super_tako","super_wani","super_shocker","super_ookamiuo","super_ushi","super_penguin","super_ari","super_sasori_new","super_love_core3","super_kangaroo2"};
