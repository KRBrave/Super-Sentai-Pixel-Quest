...
//implements IBossDisplayData
{
	...
	public Entity_Marika(World par1World)
	{
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(GaimItems.genesis_driver_marika));
...
if (!this.world.isRemote){
	this.dropItem(GaimItems.himawari_energy_lockseed, 5);
		...
		{
		case 0:
			this.dropItem(GaimItems.marron_energy_lockseed, 1);
			break;
		}
   		switch (this.rand.nextInt(5))
		{
		case 0:
			this.dropItem(GaimItems.peach_lockseed, 1);
			break;
		}
   		switch (this.rand.nextInt(5))
		{
		case 0:
			this.dropItem(GaimItems.lychee_energy_lockseed, 1);
			break;
		}
   		switch (this.rand.nextInt(5))
		{
		case 0:
			this.dropItem(GaimItems.fifteen_energy_lockseed, 1);
			break;
		}
   		switch (this.rand.nextInt(5))
		{
		case 0:
			this.dropItem(GaimItems.maja_energy_lockseed, 1);
			break;
		}
       }
