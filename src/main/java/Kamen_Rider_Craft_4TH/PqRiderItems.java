...
public class PqRiderItems {
	...
	public static Item super_lion = new Itemmedal(56, "1","super_lion").setCreativeTab(Tabs.tabOOO);
	public static Item super_sai = new Itemmedal(57, "1","super_sai").setCreativeTab(Tabs.tabOOO);
	public static Item super_shachi = new Itemmedal(58, "1","super_shachi").setCreativeTab(Tabs.tabOOO);
	public static Item super_cobra = new Itemmedal(59, "1","super_cobra").setCreativeTab(Tabs.tabOOO);
	public static Item super_same = new Itemmedal(60, "1","super_same").setCreativeTab(Tabs.tabOOO);
	public static Item super_shika = new Itemmedal(61, "1","super_shika").setCreativeTab(Tabs.tabOOO);
	public static Item super_seiuchi = new Itemmedal(62, "1","super_seiuchi").setCreativeTab(Tabs.tabOOO);
	public static Item super_mukade = new Itemmedal(63, "1","super_mukade").setCreativeTab(Tabs.tabOOO);
	public static Item super_ebi_new = new Itemmedal(64, "1","super_ebi_new").setCreativeTab(Tabs.tabOOO);
	public static Item super_ptera = new Itemmedal(66, "1","super_ptera").setCreativeTab(Tabs.tabOOO);
	public static Item super_kuwagata = new Itemmedal(67, "1","super_kuwagata").setCreativeTab(Tabs.tabOOO);
	
	public static Item super_tricera = new Itemmedal(73, "2","super_tricera").setCreativeTab(Tabs.tabOOO);
	public static Item super_kujaku = new Itemmedal(74, "2","super_kujaku").setCreativeTab(Tabs.tabOOO);
	public static Item super_kamakiri = new Itemmedal(75, "2","super_kamakiri").setCreativeTab(Tabs.tabOOO);
	public static Item super_gorilla = new Itemmedal(76, "2","super_gorilla").setCreativeTab(Tabs.tabOOO);
	public static Item super_unagi = new Itemmedal(77, "2","super_unagi").setCreativeTab(Tabs.tabOOO);
	public static Item super_kame = new Itemmedal(78, "2","super_kame").setCreativeTab(Tabs.tabOOO);
	public static Item super_imagin = new Itemmedal(79, "2","super_imagin").setCreativeTab(Tabs.tabOOO);
	public static Item super_kujira = new Itemmedal(80, "2","super_kujira").setCreativeTab(Tabs.tabOOO);
	public static Item super_gazelle = new Itemmedal(81, "2","super_gazelle").setCreativeTab(Tabs.tabOOO);
	public static Item super_shirokuma = new Itemmedal(82, "2","super_shirokuma").setCreativeTab(Tabs.tabOOO);
	public static Item super_hachi = new Itemmedal(83, "2","super_hachi").setCreativeTab(Tabs.tabOOO);
	public static Item super_kani_new = new Itemmedal(84, "2","super_kani_new").setCreativeTab(Tabs.tabOOO);
	public static Item super_panda = new Itemmedal(85, "2","super_panda").setCreativeTab(Tabs.tabOOO);
	public static Item super_kangaroo = new Itemmedal(86, "2","super_kangaroo").Shift_form(78, "3").setCreativeTab(Tabs.tabOOO);
	public static Item super_yadokari = new Itemmedal(87, "2","super_yadokari").setCreativeTab(Tabs.tabOOO);
	
	public static Item super_tyranno = new Itemmedal(65, "3","super_tyranno").setCreativeTab(Tabs.tabOOO);
	public static Item super_condor = new Itemmedal(66, "3","super_condor").setCreativeTab(Tabs.tabOOO);
	public static Item super_cheetah = new Itemmedal(67, "3","super_cheetah").setCreativeTab(Tabs.tabOOO);
	public static Item super_zou = new Itemmedal(68, "3","super_zou").setCreativeTab(Tabs.tabOOO);
	public static Item super_tako = new Itemmedal(69, "3","super_tako").setCreativeTab(Tabs.tabOOO);
	public static Item super_wani = new Itemmedal(70, "3","super_wani").setCreativeTab(Tabs.tabOOO);
	public static Item super_shocker = new Itemmedal(71, "3","super_shocker").setCreativeTab(Tabs.tabOOO);
	public static Item super_ookamiuo = new Itemmedal(72, "3","super_ookamiuo").setCreativeTab(Tabs.tabOOO);
	public static Item super_ushi = new Itemmedal(73, "3","super_ushi").setCreativeTab(Tabs.tabOOO);
	public static Item super_penguin = new Itemmedal(74, "3","super_penguin").setCreativeTab(Tabs.tabOOO);
	public static Item super_ari = new Itemmedal(75, "3","super_ari").setCreativeTab(Tabs.tabOOO);
	public static Item super_sasori_new = new Itemmedal(76, "3","super_sasori_new").setCreativeTab(Tabs.tabOOO);
	
	public static Item super_love_core = new Itemmedal(65, "1","super_love_core").setCreativeTab(Tabs.tabOOO);
	public static Item super_love_core2 = new Itemmedal(88, "2","super_love_core2").setCreativeTab(Tabs.tabOOO);
	public static Item super_love_core3 = new Itemmedal(77, "3","super_love_core3").setCreativeTab(Tabs.tabOOO);
