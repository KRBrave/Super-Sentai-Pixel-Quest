...
public class GaimItems {
    ...
    public static Item haljo_heguri_lockseed = new Item_lockseed(1,69,"haljo_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item diyu_heguri_lockseed = new Item_lockseed(1,70,"diyu_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item lucifer_heguri_lockseed = new Item_lockseed(1,71,"lucifer_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item silver_lucifer_heguri_lockseed = new Item_lockseed(1,72,"silver_lucifer_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item golden_lucifer_heguri_lockseed = new Item_lockseed(1,73,"golden_lucifer_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item proto_nokuni_heguri_lockseed = new Item_lockseed(1,74,"proto_nokuni_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item enma_heguri_lockseed = new Item_lockseed(1,75,"enma_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item black_lucifer_heguri_lockseed = new Item_lockseed(1,76,"black_lucifer_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item nether_heguri_lockseed = new Item_lockseed(1,77,"nether_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item abyss_heguri_lockseed = new Item_lockseed(1,78,"abyss_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item naraka_heguri_lockseed = new Item_lockseed(1,79,"naraka_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item helreginn_heguri_lockseed = new Item_lockseed(1,80,"helreginn_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item apollyon_heguri_lockseed = new Item_lockseed(1,81,"apollyon_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item taishan_heguri_lockseed = new Item_lockseed(1,82,"taishan_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item orcus_heguri_lockseed = new Item_lockseed(1,83,"orcus_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item inferno_heguri_lockseed = new Item_lockseed(1,84,"inferno_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item nokuni_heguri_lockseed = new Item_lockseed(1,85,"nokuni_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item tartarus_heguri_lockseed = new Item_lockseed(1,86,"tartarus_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item daimaoh_heguri_lockseed = new Item_lockseed(1,87,"daimaoh_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item zetsubo_heguri_lockseed = new Item_lockseed(1,88,"zetsubo_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item taizai_heguri_lockseed = new Item_lockseed(1,89,"taizai_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item yomi_heguri_lockseed = new Item_lockseed(1,90,"yomi_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item sin_heguri_lockseed = new Item_lockseed(1,91,"sin_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item hades_heguri_lockseed = new Item_lockseed(1,92,"hades_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item jigoku_heguri_lockseed = new Item_lockseed(1,93,"jigoku_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
    public static Item submondo_heguri_lockseed = new Item_lockseed(1,94,"submondo_heguri_lockseed").isYomi().setCreativeTab(Tabs.tabGaim);
