...
public class item_lupat_ranger_armor extends ItemArmor implements IHasModel
{
	...
	public String Show;
	public item_lupat_ranger_armor (String name, String show,ArmorMaterial par2EnumArmorMaterial,int par3, EntityEquipmentSlot par4)
	{
		...
		if (entity instanceof EntityLivingBase){
			...
			if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null){
				...
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()instanceof  item_vs_changer){
						...
						{
							if (rider=="lupin_hammer" || rider=="lupin_jackpot" || rider=="lupin_music" || rider=="lupin_paint" || rider=="lupin_prism" || rider=="lupin_christmas" || rider=="lupin_special" || rider=="lupin_fire_storm" || rider=="lupin_prision_chain" || rider=="lupin_striker")
							{
								return Refercence.MODID+":textures/armor/lupin_red_"+item_vs_changer.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
							}
							else
							{
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel){
		...
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_lupat_ranger_armor)
			{
